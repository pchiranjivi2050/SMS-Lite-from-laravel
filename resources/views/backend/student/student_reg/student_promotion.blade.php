                ...
                <div class="panel-wrapper collapse in" aria-expanded="true">
                    <div class="panel-body">
                        <div class="row">          
                            <div class="col-sm-12">
                                <div class="white-box">
                                    <form method="POST" action="{{route('student.upgrade',$editData->student_id)}}" enctype="multipart/form-data">
                                        @csrf
                                        <!-- /.1st row inside form -->
                                        <div class="row">
                                            <div class="col-sm-4">
                                                ...
                                                <input type="text" class="form-control"name="name" id="name" value="{{$editData['student']['name']}}" placeholder="Student Name" required="" disabled>
                                                <input type="hidden" class="form-control"name="id" id="id" value="{{$editData->id}}" placeholder="Student ID No" required="" disabled>
                                            ...
                                            <div class="col-sm-4">
                                                ...
                                                <input type="text" class="form-control"name="id_no" id="id_no" value="{{$editData->id_no}}" placeholder="ID No" required="" disabled>
                                                <div class="help-block with-errors"></div>
                                                </div>
                                            </div> <!-- /.col-sm-4 inside form -->
                                            <div class="col-sm-4">
                                                ...
                                                <input type="text" class="form-control" id="fname" name="fname" value="{{$editData['student']['fname']}}" placeholder="Father Name" required="" disabled>
                                                <div class="help-block with-errors"></div>
                                                </div>
                                            </div> <!-- /.col-sm-4 inside form -->
                                            <div class="col-sm-4">
                                                ...
                                                <input type="text" class="form-control" id="mname" name="mname" value="{{$editData['student']['mname']}}" placeholder="Mother Name" required="" disabled>
                                                <div class="help-block with-errors"></div>
                                                </div>
                                            </div> <!-- /.col-sm-4 inside form -->
                                            <div class="col-sm-4">
                                                ...
                                                <input type="date" class="form-control" id="dob" name="dob" value="{{$editData['student']['dob']}}"  required="" disabled>
                                                <div class="help-block with-errors"></div>
                                                </div>
                                            </div> <!-- /.col-sm-4 inside form -->
                                            <div class="col-sm-4">
                                                ...
                                                <input type="text" class="form-control" id="address" name="address" value="{{$editData['student']['address']}}" placeholder="Address" required="" disabled>
                                                <div class="help-block with-errors"></div>
                                                </div>
                                            </div> <!-- /.col-sm-4 inside form -->
                                            <div class="col-sm-4">
                                                ...
                                                <input type="text" class="form-control" id="mobile" name="mobile" value="{{$editData['student']['mobile']}}" placeholder="Mobile No" required="" disabled>
                                                <div class="help-block with-errors"></div>
                                                </div>
                                            </div> <!-- /.col-sm-4 inside form -->
                                            <div class="col-sm-4">
                                                ...
                                                <input type="email" class="form-control" id="email" name="email" value="{{$editData['student']['email']}}" placeholder="Email" data-error="Bruh, that email address is invalid" required="" disabled>
                                                <div class="help-block with-errors"></div>
                                                </div>
                                            </div> <!-- /.col-sm-4 inside form -->
                                            <div class="col-md-4">                  
                                            ...
                                            <div class="col-sm-4">
                                                ...
                                                <input type="text" class="form-control" id="blood_group" name="blood_group" value="{{$editData['student']['blood_group']}}" placeholder="Blood Group" required="" disabled>
                                                <div class="help-block with-errors"></div>
                                                </div>
                                            </div> <!-- /.col-sm-4 inside form -->
                                            <div class="col-sm-4">
                                                ...
                                                <input type="text" class="form-control" id="health" name="health" value="{{$editData->health}}" placeholder="Health Problem" required="" disabled>
                                                <div class="help-block with-errors"></div>
                                                </div>
                                            </div> <!-- /.col-sm-4 inside form -->
                                            <div class="col-md-4">                  
                                                ...
                                                <div class="controls">
                                                    <select name="religion" id="religion" required="" class="form-control" disabled>
                                                        <option value="" selected="" disabled="">Select User Type</option>
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="file" class="form-control" id="birth_certificate" name="birth_certificate" disabled>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-sm-4">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="text" class="form-control" id="pre_school" name="pre_school" value="{{$editData->pre_school}}" placeholder="Previous School Name" disabled>
                                                                                <div class="help-block with-errors"></div>
                                                                            </div>
                                                                        </div> <!-- /.col-sm-4 inside form -->
                                                                        <div class="col-sm-4">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="text" class="form-control" id="pre_school_address" name="pre_school_address" value="{{$editData->pre_school_address}}" placeholder="Previous School Address" disabled>
                                                                                <div class="help-block with-errors"></div>
                                                                            </div>
                                                                        </div> <!-- /.col-sm-4 inside form -->
                                                                        <div class="col-sm-4">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="text" class="form-control" id="reason" name="reason" value="{{$editData->reason}}" placeholder="Reason" disabled>
                                                                                <div class="help-block with-errors"></div>
                                                                            </div>
                                                                        </div> <!-- /.col-sm-4 inside form -->
                                                                        <div class="col-sm-4">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="text" class="form-control" id="pre_class" name="pre_class" value="{{$editData->pre_class}}" placeholder="Previous School Class" disabled>
                                                                                <div class="help-block with-errors"></div>
                                                                            </div>
                                                                        </div> <!-- /.col-sm-4 inside form -->
                                                                        <div class="col-sm-4">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="date" class="form-control" id="pre_admission" name="pre_admission" value="{{$editData->pre_admission}}"  disabled>
                                                                                <div class="help-block with-errors"></div>
                                                                            </div>
                                                                        </div> <!-- /.col-sm-4 inside form -->
                                                                        <div class="col-sm-4">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="date" class="form-control" id="pre_leaving" name="pre_leaving" value="{{$editData->pre_leaving}}"  disabled>
                                                                                <div class="help-block with-errors"></div>
                                                                            </div>
                                                                        </div> <!-- /.col-sm-4 inside form -->
                                                                        <div class="col-sm-4">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="file" class="form-control" id="pre_marksheet" name="pre_marksheet" value="{{asset('upload/student_image/pre_marksheet/'.$editData->pre_marksheet)}}" disabled>
