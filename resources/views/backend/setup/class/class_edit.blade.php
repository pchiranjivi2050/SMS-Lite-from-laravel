...
<div class="row">          
    <div class="col-sm-12">
        <div class="white-box">
            <form method="post" action="{{route('update.class',$editData->id)}}">
            @csrf
                <!-- /.1st row inside form -->
                <div class="row">
                    <div class="col-sm-4">
                        ...
                        <input type="text" class="form-control" id="name" name="name" value="{{$editData->name}}" placeholder="Class" required="">
