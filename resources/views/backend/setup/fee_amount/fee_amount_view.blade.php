    ...
    <div class="row">
        <div class="col-md-6"><!-- col-md-6 -->
            <div class="row"> <!-- /row2 -->
                <div class="col-md-12">
                    <div class="white-box">
                        <h3 class="box-title m-b-0">View Fee Amount</h3>
                        ...
                        <div class="table-responsive">
                            <table id="example23" class="display nowrap" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{ $key+1 }}</td>
                                        <td>{{ $fee_category['fee_category']['name'] }}</td>
                                        <td>
                                        <a href="{{route('fee.amount.edit',$fee_category->fee_category_id)}}" class="btn btn-rounded btn-info" title="Edit And Details"><i class="fa fa-info-circle" aria-hidden="true"></i></a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
...
@include('admin.body.footer')
   ...
   <script type="application/javascript">
        ...
        $('#blockbtn').click(function() {
            $('div.block').block({
                message: '<h6><img src="{{asset('plugins/images/busy.gif')}}" /> <strong>Click Add Fee Amount</strong></h6>',
                css: {
