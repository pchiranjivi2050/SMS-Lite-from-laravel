               ...
               <div class="panel-wrapper collapse in" aria-expanded="true">
                   <div class="panel-body">
                       <div class="row">          
                           <div class="col-sm-12">
                               <div class="white-box">
                                   <form method="POST" action="{{route('employee.update',$editData->employee_id)}}" enctype="multipart/form-data">
                                       @csrf
                                       <!-- /.1st row inside form -->
                                       <div class="row">
                                            <div class="col-sm-2">
                                       ...
                                       <div class="row">
                                           <div class="col-sm-4">
                                               ...
                                               <input type="text" class="form-control"name="name" id="name" value="{{$editData['employee']['name']}}" placeholder="Employee Name" required="">
                                           ...
                                           <div class="col-sm-4">
                                               ...
                                               <input type="text" class="form-control" id="fname" name="fname" value="{{$editData['employee']['fname']}}" placeholder="Father Name" required="">
                                               <div class="help-block with-errors"></div>
                                               </div>
                                           </div> <!-- /.col-sm-4 inside form -->
                                           <div class="col-sm-4">
                                               ...
                                               <input type="text" class="form-control" id="mname" name="mname" value="{{$editData['employee']['mname']}}" placeholder="Mother Name" required="">
                                               <div class="help-block with-errors"></div>
                                               </div>
                                           </div> <!-- /.col-sm-4 inside form -->
                                           <div class="col-sm-4">
                                               ...
                                               <input type="date" class="form-control" id="dob" name="dob" value="{{$editData['employee']['dob']}}"  required="">
                                               <div class="help-block with-errors"></div>
                                               </div>
                                           </div> <!-- /.col-sm-4 inside form -->
                                           <div class="col-sm-4">
                                               ...
                                               <input type="text" class="form-control" id="address" name="address" value="{{$editData['employee']['address']}}" placeholder="Address" required="">
                                               <div class="help-block with-errors"></div>
                                               </div>
                                           </div> <!-- /.col-sm-4 inside form -->
                                           <div class="col-sm-4">
                                               ...
                                               <input type="text" class="form-control" id="mobile" name="mobile" value="{{$editData['employee']['mobile']}}" placeholder="Mobile No" required="">
                                               <div class="help-block with-errors"></div>
                                               </div>
                                           </div> <!-- /.col-sm-4 inside form -->
                                           <div class="col-sm-4">
                                               ...
                                               <input type="email" class="form-control" id="email" name="email" value="{{$editData['employee']['email']}}" placeholder="Email" data-error="Bruh, that email address is invalid" required="">
                                               <div class="help-block with-errors"></div>
                                               </div>
                                           </div> <!-- /.col-sm-4 inside form -->
                                           <div class="col-sm-4">
                                            ...
                                            <input type="text" class="form-control" id="qualification" name="qualification" value="{{$editData['employee']['qualification']}}" placeholder="Qualification" required="">
                                            <div class="help-block with-errors"></div>
                                            </div>
                                        </div> <!-- /.col-sm-4 inside form -->
                                           <div class="col-md-4">                  
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <input type="text" class="form-control" id="salary" name="salary" value="{{$editData['employee']['salary']}}" placeholder="Salary" required="">
                                            <div class="help-block with-errors"></div>
                                            </div>
                                        </div> <!-- /.col-sm-4 inside form -->
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                            <h5><strong>My Word</strong><span class="text-danger">*</span></h5>
                                            <input type="text" class="form-control" id="word" name="word" value="{{$editData->word}}" placeholder="My Word" >
                                            <div class="help-block with-errors"></div>
                                            </div>
                                        </div> <!-- /.col-sm-4 inside form -->
                                           <div class="col-md-4">                  
                                           ...
                                           <div class="col-sm-4">
                                               ...
                                               <input type="text" class="form-control" id="blood_group" name="blood_group" value="{{$editData['employee']['blood_group']}}" placeholder="Blood Group" required="">
                                               <div class="help-block with-errors"></div>
                                               </div>
                                           </div> <!-- /.col-sm-4 inside form -->
                                           <div class="col-sm-4">
                                           ...
                                           <div class="col-sm-4">
                                               ...
                                               <input type="date" class="form-control" id="join_date" name="join_date" value="{{$editData->join_date}}"  required="">
                                               <div class="help-block with-errors"></div>
                                               </div>
                                           </div> <!-- /.col-sm-4 inside form -->
                                           <hr width="90%">
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <input type="text" class="form-control" id="bank_name" name="bank_name" value="{{$editData->bank_name}}" placeholder="Bank Name" required="">
                                            <div class="help-block with-errors"></div>
                                            </div>
                                        </div> <!-- /.col-sm-4 inside form -->
                                        <div class="col-sm-4">
                                            ...
                                            <input type="text" class="form-control" id="bank_branch" name="bank_branch" value="{{$editData->bank_branch}}" placeholder="Branch" required="">
                                            <div class="help-block with-errors"></div>
                                            </div>
                                        </div> <!-- /.col-sm-4 inside form -->
                                        <div class="col-sm-4">
                                            ...
                                            <input type="text" class="form-control" id="account_name" name="account_name" value="{{$editData->account_name}}" placeholder="Account Holder Name" required="">
                                            <div class="help-block with-errors"></div>
                                            </div>
                                        </div> <!-- /.col-sm-4 inside form -->
                                        <div class="col-sm-4">
                                            ...
                                            <input type="text" class="form-control" id="account_no" name="account_no" value="{{$editData->account_no}}" placeholder="Account Number" required="">
                                            <div class="help-block with-errors"></div>
                                            </div>
                                        </div> <!-- /.col-sm-4 inside form -->
                                                                   ...
                                                                   <div class="row">
                                                                       ...
                                                                       <div class="col-sm-4">
                                                                           <div class="form-group">
                                                                               ...
                                                                               <input type="text" class="form-control" id="pre_designation" name="pre_designation" value="{{$editData->pre_designation}}" placeholder="Previous School Designation" >
                                                                               <div class="help-block with-errors"></div>
                                                                           </div>
                                                                       </div> <!-- /.col-sm-4 inside form -->
                                                                       <div class="col-sm-4">
                                                                           <div class="form-group">
                                                                               ...
                                                                               <input type="date" class="form-control" id="pre_join_date" name="pre_join_date" value="{{$editData->pre_join_date}}"  >
                                                                               <div class="help-block with-errors"></div>
                                                                           </div>
                                                                       </div> <!-- /.col-sm-4 inside form -->
                                                                       <div class="col-sm-4">
                                                                           <div class="form-group">
                                                                               ...
                                                                               <input type="date" class="form-control" id="pre_leave_date" name="pre_leave_date" value="{{$editData->pre_leave_date}}"  >
                                                                               <div class="help-block with-errors"></div>
                                                                           </div>
                                                                       </div> <!-- /.col-sm-4 inside form -->
                                                                       <div class="col-sm-4">
