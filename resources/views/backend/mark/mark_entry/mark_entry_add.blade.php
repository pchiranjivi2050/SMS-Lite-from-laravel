...
<form method="post" action="{{route('mark.entry.store')}}">
@csrf
                ...
                <table id="example23" class="display nowrap" cellspacing="0" width="100%">
                    ...
                    <tbody>
                        ...
                        <input type="hidden" name="id_no[]" value="{{ $mark_entry->id_no }}">
                            ...
                            <td class="text-center">{{ $mark_entry->roll }}</td>
                            <td>
                                <div class="controls">
                            ...
                            <td>
                                <div class="controls">
                                    <input type="text" name="practical_marks[]" id="practical_marks[]"  class="form-control">              
                                </div>
                            </td>
                        </tr>
                        @endforeach
