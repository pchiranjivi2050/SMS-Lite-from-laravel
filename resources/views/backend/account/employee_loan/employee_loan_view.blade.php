    ...
    <div class="row"><!-- /row form  Add User Form-->
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="panel panel-success ">
                <div class="panel-heading block"> Employee Loan Get
                ...
                <div class="panel-wrapper collapse in" aria-expanded="true">
                    <div class="panel-body">
                        <form method="get" action="{{route('employee.loan.get')}}">
                            @csrf
                            <div class="row">
                                <div class="col-md-4">
                    ...
                    <table id="example23" class="display nowrap" cellspacing="0" width="100%" >
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('employee.loan.pay',[$loan->loan_no,$loan->employee_id,$loan->designation_id])}}" class="btn btn-rounded btn-info" title="Pay Lone"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                                    <a href="{{route('loan.pay.detail',[$loan->loan_no,$loan->employee_id,$loan->designation_id])}}" class="btn btn-rounded btn-danger" title="Loan Detail View"><i class="fa fa-eye" aria-hidden="true"></i></a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
