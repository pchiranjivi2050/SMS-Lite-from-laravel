                ...
                <div class="panel-wrapper collapse in" aria-expanded="true">
                    <div class="panel-body">
                        <div class="row">          
                            <div class="col-sm-12">
                                <div class="white-box">
                                    <form method="POST" action="{{ route('extra.income.store') }}">
                                        @csrf
                                        <!-- /.1st row inside form -->
                                        <div class="row">
                                            <div class="col-sm-2">
                                                ...
                                                <input type="text" class="form-control" id="bill_no" name="bill_no" placeholder="Bill No" value="{{$finalBill}}" required="" readonly>
                                            ...
                                            <div class="col-sm-2">
                                                ...
                                                <input type="date" class="form-control" id="date" name="date" placeholder="" value="{{now()->toDateString('Y-m-d')}}" required="">
                                                <div class="help-block with-errors"></div>
                                                </div>
                                            </div> <!-- /.col-sm-4 inside form -->
                                            <hr>
