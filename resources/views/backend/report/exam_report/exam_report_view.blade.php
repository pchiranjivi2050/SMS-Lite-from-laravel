    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><!--<a class="btn btn-rounded bg-success btn-outline m-b-20" id="unblockbtn">Edit Setting</a> <a class="btn btn-outline m-b-20 m-r-20 invisible" id="blockbtn">Custom Message</a>-->
            <div class="panel panel-success ">
                <div class="panel-heading block">Student Exam Report View
                ...
                <div class="panel-wrapper collapse in" aria-expanded="true">
                    <div class="panel-body">
                        <div class="row">          
                            <div class="col-sm-12">
                                <div class="white-box">
                                    <form method="get" action="{{route('exam.report.get')}}" target="_blank">
                                        @csrf
                                        <!-- /.1st row inside form -->
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <select name="year_id"  required="" class="form-control">
                                                            ...
                                                            <option value="{{ $year->id }}" {{($nepaliYear == $year->name)? 'selected': ''}} >{{ $year->name }}</option>
                                                            @endforeach
                                                        </select>
                                            ...
                                            <div class="col-sm-4">
                                                ...
                                                <input type="text" class="form-control"name="id_no" id="id_no" value="" placeholder="Student ID No" required="">
